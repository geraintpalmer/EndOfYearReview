...
Stochastic aspects will need to be captured, such as those governing the variability in patient pathways and resource consumption.
...
An aging population means and increasing amount of elderly people are accessing  healthcare service.
