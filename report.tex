...
\subsubsection{Solving using Differential Difference}
...
In this case, we are modelling the queue as a Markov chain and solving from first principles, rather than manipulating transition matrices in the next subsection.
