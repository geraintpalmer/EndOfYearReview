...
\begin{tikzpicture}
  ...
  \draw (9.25, 2.5) circle (1) node {\large{$(A_1, 4, \emptyset)$}}; % Servcie top A
  \draw (9.25, 0) circle (1) node {\large{$(A_2, 5, \emptyset)$}}; % Service bottom A
  ...
  \draw (25.25, 1.25) circle (1) node {\large{$(B_1, 9, \emptyset)$}}; % Service B
  ...
  \draw (11.25, 8) circle (1) node {\large{$(C_2, 13, \emptyset)$}}; % Service bottom C
