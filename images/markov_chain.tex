...
\begin{tikzpicture}
    ...
    \draw ($(21)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(30)+(0.1,0.3)$);
    \draw ($(11)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(20)+(0.1,0.3)$);
    \draw ($(01)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(10)+(0.1,0.3)$);

    \draw ($(22)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(31)+(0.1,0.3)$);
    \draw ($(12)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(21)+(0.1,0.3)$);
    \draw ($(02)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(11)+(0.1,0.3)$);

    \draw ($(13)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(22)+(0.1,0.3)$);
    \draw ($(03)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(12)+(0.1,0.3)$);

    \draw ($(04)+(-0.4,-0.2)$) edge[->,thick] node [left] {\tiny$r_{12}\mu_1$} ($(13)+(0.1,0.3)$);
